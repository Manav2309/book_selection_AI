...
# Function to get top 100 books in a genre
def get_top_100_books(genre):
    return book_data.get(genre, [])[:100]

# Function to get top 10 books based on ratings
...
if st.session_state.top_100_books:
    ...
    # Step 2: Agent finds top 10 books from the top 100 based on ratings
